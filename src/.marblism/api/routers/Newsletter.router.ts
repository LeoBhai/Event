...
export default function createRouter<Config extends BaseConfig>(router: RouterFactory<Config>, procedure: ProcBuilder<Config>) {
    return router({
        ...
        createMany: procedure.input($Schema.NewsletterInputSchema.createMany).mutation(async ({ ctx, input }) => checkMutate(db(ctx).newsletter.createMany(input as any))),
        ...
        deleteMany: procedure.input($Schema.NewsletterInputSchema.deleteMany).mutation(async ({ ctx, input }) => checkMutate(db(ctx).newsletter.deleteMany(input as any))),
        ...
        findFirst: procedure.input($Schema.NewsletterInputSchema.findFirst).query(({ ctx, input }) => checkRead(db(ctx).newsletter.findFirst(input as any))),

        findMany: procedure.input($Schema.NewsletterInputSchema.findMany).query(({ ctx, input }) => checkRead(db(ctx).newsletter.findMany(input as any))),
